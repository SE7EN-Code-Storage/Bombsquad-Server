...
def read_args():
    ...
    g3.add_argument("--save",
                    metavar="FILENAME",
                    help="Dump the loaded brain to a file")
    g3.add_argument("--interactive",
                    "-i",
                    action="store_true",
                    help="Enter interactive mode")
    g3.add_argument("--batch", "-b", help="Send a series of inputs to the bot")
...
def main():
    ...
    if args.standard:
        ...
        kern.bootstrap(learnFiles="startup.xml",
        ...
        kern.bootstrap(learnFiles=args.aiml,
