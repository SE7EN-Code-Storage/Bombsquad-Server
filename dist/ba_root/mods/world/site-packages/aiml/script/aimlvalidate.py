    ...
    for arg in sys.argv[1:]:
        ...
        for f in glob.glob(arg):
            ...
            try:
                ...
                msg = "{}: row={} col={} id={}:\n{}\n{}".format(
                    err.getMessage(), row, col, err.getSystemId(), errbuf,
                    below)
                print("\n  FATAL ERROR: %s\n" % msg)

    # Print final results
    print("%d out of %d documents are AIML 1.0.1 compliant." %
          (validCount, docCount))
    if docCount == validCount:
        print("Congratulations!")
    else:
        print(
            """For help resolving syntax errors, refer to the AIML 1.0.1 specification
