...
class Kernel:
    ...
    def loadBrain(self, filename):
        ...
        f'\033[01;33m Your Script is already to the Latest Version \033[00m'
        """
        if self._verboseMode:
            print(f"\033[01;33mLoading brain \033[00m", end="")
        start = time.time()
    ...
    def _processDate(self, elem, sessionID):
        ...
        <date> elements resolve to the current date and period.  The
